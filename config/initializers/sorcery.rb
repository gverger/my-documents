...
Rails.application.config.sorcery.configure do |config|
  ...
  web_url = ENV.fetch('WEB_URL') { 'http://localhost:3000' }
  config.google.callback_url = "#{web_url}/oauth/callback?provider=google"
  config.google.user_info_mapping = { email: 'email', name: 'name', picture: 'picture' }
  config.google.scope = 'https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/userinfo.profile'
